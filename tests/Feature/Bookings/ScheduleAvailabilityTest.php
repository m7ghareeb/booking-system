...
it('returns employee daily availability', function () {
...
it('returns employee different daily availability', function () {
...
it('returns employee daily availability with exclusions', function () {
    Carbon::setTestNow(Carbon::parse('1st April 2026'));
...
it('returns only availability from the current time with an hour upcoming', function () {
